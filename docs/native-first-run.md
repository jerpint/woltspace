...
`npm pack` prints the file list and leaves `woltspace-tui-0.5.0-rc.2.tgz` in `tui/`;
...
```console
$ woltspace --version
woltspace 0.5.0-rc.2

$ woltspace-tui --version --json
{"name":"@woltspace/tui","version":"0.5.0-rc.2","binary":"woltspace-tui"}
```
...
{"name":"@woltspace/tui","version":"0.5.0-rc.2","binary":"woltspace-tui-service"}
```
...
source: local
package: @woltspace/tui@0.5.0-rc.2
...
source: npx
package: @woltspace/tui@0.5.0-rc.2
command: /usr/local/bin/npx --yes --package=@woltspace/tui@0.5.0-rc.2 woltspace-tui
woltspace: ignoring /nonexistent/woltspace-tui — [Errno 2] No such file or directory: '/nonexistent/woltspace-tui'; resolving @woltspace/tui@0.5.0-rc.2 through npx instead.
woltspace: if that fails because @woltspace/tui@0.5.0-rc.2 is not published yet, install both artifacts from a checkout: uv tool install . && cd tui && npm pack && npm install -g ./woltspace-tui-0.5.0-rc.2.tgz
```
