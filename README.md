...
```bash
woltspace rebuild              # latest tagged release
woltspace rebuild --nightly    # latest main tip (may be rough)
```
...
woltspace rebuild --branch <name>   # build from a remote branch
```
...
- [CLAUDE.md](CLAUDE.md) — for developers and agents working on the platform
