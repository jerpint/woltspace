...
// VENDORED from public/static/sprites.js so the desktop boot screen can render
// the colony's pixel art offline (before the container/lodge is reachable).
// Keep in sync with the source; ES-module exports are added at the bottom.
...
export { WOLT_SPRITES, WOLT_EMOJI, RODENT_TYPES, WOLT_TYPES, woltSpriteAvatar, BG_SPRITE_PAL, BG_SPRITE_MAPS, renderBgSprite };
