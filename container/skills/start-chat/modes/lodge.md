...
Use `push-view /wolt/<your-wolt-name>/site/page.html` — that's all you need. Your wolt name is in `$WOLT_NAME`. Load the woltspace viewport skill for full details.
