...
**IMPORTANT**: To send a message to the developer, ALWAYS use `notify "your message"`. Never call /woltspace-notify via curl directly — the notify script handles session routing, emoji prefix, and delivery correctly.
